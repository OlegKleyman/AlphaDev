...
namespace AlphaDev.Web.Tests.Integration.Features
{
	public partial class DeleteBlog_feature: WebFeatureFixture
	{
	    ...
	    public DeleteBlog_feature(ITestOutputHelper output, DatabaseWebServerFixture databaseWebServerFixture) : base(output, databaseWebServerFixture)
	    {
	    ...
	    private void Then_it_should_be_deleted()
	    {
	        ...
	        DatabasesFixture.BlogContextDatabaseFixture.BlogContext.Blogs.Where(blog => blog.Id == addedBlog.Id).Should()
	            .BeEmpty();
	    }
