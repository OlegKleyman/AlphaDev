...
namespace AlphaDev.Web.Core.Tests.Unit
{
    public class SaveFilterTests
    {
        ...
        public async Task OnActionExecutionAsyncSavesTokenWhenExecutedContextOnlyWhenExceptionConditionsAreMet(
            bool exceptionOccured, bool exceptionHandled, bool saved)
        {
