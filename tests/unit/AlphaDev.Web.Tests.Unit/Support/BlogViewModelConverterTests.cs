...
namespace AlphaDev.Web.Tests.Unit.Support
{
    public class BlogViewModelConverterTests
    {
        ...
        public void ReadJsonShouldReturnBlogViewModelWithoutModifiedDateWhenItDoesntExist()
        {
            ...
            var cache = new StringReader("{\"Id\":0,\"Title\":\"title\",\"Content\":\"content\",\"Dates\":{\"Created\":\"2018-01-01T00:00:00\"}}");
        ...
        public void ReadJsonShouldReturnBlogViewModelWithoutModifiedDateWhenItExistsButIsNotDateTime()
        {
            ...
            var cache = new StringReader("{\"Id\":0,\"Title\":\"title\",\"Content\":\"content\",\"Dates\":{\"Created\":\"2018-01-01T00:00:00\",\"Modified\": null}}");
        ...
        public void ReadJsonShouldReturnBlogViewModelWithModifiedDateWhenItExists()
        {
            ...
            var cache = new StringReader("{\"Id\":0,\"Title\":\"title\",\"Content\":\"content\",\"Dates\":{\"Created\":\"2018-01-01T00:00:00\",\"Modified\":\"2018-02-18T00:00:00\"}}");
        ...
        [Theory]
        [MemberData(nameof(BlogViewModelConverterTestsTheories.ReadJsonShouldThrowAnArgumentExceptionWhenRequiredKeysAreMissingValueTheory), MemberType =
            typeof(BlogViewModelConverterTestsTheories))]
        public void ReadJsonShouldThrowAnArgumentExceptionWhenRequiredKeysAreMissingValue(JsonReader reader, string expectedKey, string type)
        {
            var converter = GetBlogViewModelConverter();

            Action readJson = () => converter.ReadJson(reader, null, null, null);
            
            readJson.Should().Throw<ArgumentException>().WithMessage($"{expectedKey} [NULL] is not castable to {type}.\r\nParameter name: reader")
        ...
        public void ReadJsonShouldThrowArgumentExceptionWhenDatesFieldIsMissing()
        {
            ...
            readJson.Should().Throw<ArgumentException>().WithMessage("Dates field is missing.\r\nParameter name: reader")
                .Which.ParamName.Should().BeEquivalentTo("reader");
        }

        [Theory]
        [MemberData(nameof(BlogViewModelConverterTestsTheories.ReadJsonShouldThrowAnArgumentExceptionWhenRequiredKeysAreNotOfTheRightTypeTheory), MemberType =
            typeof(BlogViewModelConverterTestsTheories))]
        public void ReadJsonShouldThrowAnArgumentExceptionWhenRequiredKeysAreNotOfTheRightType(JsonReader reader, string expectedKey, string type)
        {
            var converter = GetBlogViewModelConverter();
        ...
        [Theory]
        [MemberData(nameof(BlogViewModelConverterTestsTheories.ReadJsonShouldThrowAnArgumentNullExceptionWhenRequiredArgumentsAreMissingTheory), MemberType =
            typeof(BlogViewModelConverterTestsTheories))]
            ...
            object value, JsonSerializer serializer, string expectedParamName)
        {
            ...
            readJson.Should().Throw<ArgumentNullException>().WithMessage($"Value cannot be null.\r\nParameter name: {expectedParamName}")
        ...
        private class BlogViewModelConverterTestsTheories
        {
            ...
            public  static IEnumerable<object[]> ReadJsonShouldThrowAnArgumentExceptionWhenRequiredKeysAreNotOfTheRightTypeTheory = new[]
            {
                new object[]
                {
                ...
                new object[]
                {
                    Serialize(new { Id = default(int), Dates=new{Created = default(object)}}), "Created", "DateTime"
                }
            };
